...
df <- readRDS(file = 'data/processed_soil_data/decagon_data.RDS')
...
#-----------------------------------------------------------------------------------------
write.csv(check, 'data/processed_soil_data/check_dates.csv', row.names = FALSE) # write list of changes 
# ------------------------------------------------------------------------------------------- 
...
saveRDS( out , 'data/processed_soil_data/decagon_data_corrected_dates.RDS')
